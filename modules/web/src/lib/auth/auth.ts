...
export async function refreshToken(): Promise<boolean> {
  if (cookieStorageService.get(COOKIES.canRefresh) !== "y")
    return invalidRefreshAttempt("doesnt contain cookie to refresh");

  notify.info("attempting to refresh" + Math.random());
