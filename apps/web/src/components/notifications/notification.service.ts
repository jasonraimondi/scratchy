...
import type { Notify, NotifyMessage, NotifySettings } from "$ui/notifications/notifications.types";
import { NotifyType } from "$ui/notifications/notifications.types";

export class NotificationService {
  private settings: NotifySettings = { ttl: 4500, suppressDuplicates: false };

  private history: Record<string, string> | undefined;
